class APIConfig {
  ...
  static const String _devBaseUrl = "https://overcompliant-ressie-fibrously.ngrok-free.dev";

  // --- 2. 生產環境的後端網址 ---
  // 這是 App 正式上線後要連接的真實伺服器網址。
  // 在部署前，你需要將 'your.api.production.com' 替換為你的真實網域。
  static const String _prodBaseUrl = "https://overcompliant-ressie-fibrously.ngrok-free.dev";
